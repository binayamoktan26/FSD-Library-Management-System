...
export { default as VerifyUser } from "@pages/auth/VerifyUser";
...
export { default as NewBook } from "@pages/books/NewBook";
export { default as ReviewPage } from "@pages/reviews/ReviewPage";
export { default as UserPage } from "@pages/users/UserPage";
export { default as Profile } from "@pages/users/Profile";
export { default as BorrowPage } from "@pages/borrow/BorrowPage";
